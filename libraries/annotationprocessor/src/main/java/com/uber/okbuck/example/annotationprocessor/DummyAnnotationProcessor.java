...
public class DummyAnnotationProcessor extends AbstractProcessor {
  ...
  public Set<String> getSupportedAnnotationTypes() {
    return Collections.singleton(DummyAnnotation.class.getName());
  }
  ...
  public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
    for (Element annotatedType: roundEnv.getElementsAnnotatedWith(DummyAnnotation.class)) {
      try {
  ...
  private static void generateDummyClass(TypeElement annotatedType, ProcessingEnvironment processingEnv)
    ...
    String generatedClassName = annotatedType.getSimpleName().toString() + "_DummyGenerated";
