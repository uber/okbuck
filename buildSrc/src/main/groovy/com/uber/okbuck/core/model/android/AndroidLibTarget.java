...
public class AndroidLibTarget extends AndroidTarget {
    ...
    public AndroidLibTarget(Project project, String name, boolean isTest) {
        ...
        if (testExtension.espressoForLibraries
            ...
            libInstrumentationTarget = new AndroidLibInstrumentationTarget(
    ...
    public List<String> getKotlincArguments() throws ParserConfigurationException,
            ManifestMerger2.MergeFailureException, SAXException, IOException {
        ...
        getResVariantDirs().forEach((String dir, String variant) -> {
