...
public class Scope {
    private final static String PROCESSOR_BUCK_FILE_ROOT = ".okbuck/cache/processor";
    ...
    /**
     * Returns the rule name for the java_annotation_processor rule generated by this scope.
     * @return rule name of java_annotation_processor rule.
     */
    public String getAnnotationProcessorRuleName() {
        return String.format("processor_%s",
                configuration
                        .getAllDependencies()
                        .stream()
                        .map(dep -> {
    ...
    /**
     * Get the rule path of the java_annotation_processor rule generated by the scope.
     * @return rule path of the java_annotation_processor rule.
     */
    public String getAnnotationProcessorRulePath() {
        String name = getAnnotationProcessorRuleName();
        return String.format("//%s:%s", PROCESSOR_BUCK_FILE_ROOT, name);
    }
