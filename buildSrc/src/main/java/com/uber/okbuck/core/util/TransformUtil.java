...
public final class TransformUtil {
  ...
  public static void fetchTransformDeps(Project project) {
    ...
    FileUtil.copyResourceToProject(
        TRANSFORM_FOLDER + TRANSFORM_JAR, new File(cacheDir, TRANSFORM_JAR));
  }
  ...
  private static String getTransformConfigRuleForFile(Project project, File config) {
    ...
    File configFile =
        new File(project.getRootDir(), TransformUtil.TRANSFORM_CACHE + File.separator + path);
    try {
